...
cross1= Krizovatka("Dablicka x Bestakova", 3, 40)
...
pohyb2= Pohyb("S", 323, 29, 34, 1, 31, Zapad, cross1, 1, 1)
pohyb3= Pohyb("R", 140, 8, 1, 1 , 38, Zapad, cross1, 1, 1)


pohyb4 = Pohyb("L", 26, 1,0,0,4, Jih, cross1, 1, 1)
