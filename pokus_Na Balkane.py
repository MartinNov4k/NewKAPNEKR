...
cross1= Krizovatka("Spojovací x Na Balkáně", 3, 40)
...
pohyb2= Pohyb("S", 985, 62, 0, 0, 0, Zapad, cross1, 1, 1)
pohyb3= Pohyb("R", 142, 1, 0, 0 , 0, Zapad, cross1, 1, 1)


pohyb4 = Pohyb("L",26, 0,0,0,0, Jih, cross1, 1, 1, 6)
#pohyb5= Pohyb("S", 45, 5,2,0,7, Jih, cross1, 1, 1, 6)
pohyb6= Pohyb("R", 19, 1,0,0,0, Jih, cross1, 1, 1,6)

pohyb7 = Pohyb("L",71, 1,0,0,0, Vychod, cross1, 1, 1)
pohyb8= Pohyb("S", 1007, 72, 0, 0, 0, Vychod, cross1, 1, 1)
